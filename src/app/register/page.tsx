...
import { ArrowRight, Eye, EyeOff, Feather, Lock, Mail, User } from 'lucide-react';
      ...
      >
        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-xl">
          <div className="mb-6">
            ...
            <p className="text-muted-foreground text-sm">Create an account to join the community</p>
          </div>
